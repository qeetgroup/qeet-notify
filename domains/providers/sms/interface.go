// Package sms defines the Provider contract for SMS delivery adapters.
// Each concrete implementation lives in a sub-package (msg91/, twofactor/, twilio/).
package sms
...
type Message struct {
	...
	SenderID  string            // TRAI-registered Sender Header
